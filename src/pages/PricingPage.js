    ...
    <div className="container marginNavTop">
      <div className="row">
        ...
        <h2 className="textBlue mb-4">
          Pricing Page - Apply for Jobs with a Premium Plan
        </h2>
        <h4 className="text-secondary " style={{ textAlign: "justify" }}>
          Welcome to our Job Portal Pricing Page! We’re committed to helping you
          find your dream job by giving you access to the best opportunities. To
          streamline your application process, we offer an affordable,
          transparent pricing model.
        </h4>
        <button className="btn btn-primary bgBlue w-100 mt-4">Payout</button>
        ...
        <div className="col-12">
          <div className="my-2 border rounded p-4">
            ...
            <p>
              ...
              small fee helps us maintain a high-quality platform with verified
        ...
        <div className=" col-12">
          <div className="my-2 border rounded p-4">
            ...
            <p>
              ...
              automatically. <br />
              Refunds will reflect in your original payment method within 5-7
              business days. <br />
              No questions asked!
            </p>
          </div>
        ...
        <div className=" col-12">
          <div className="my-2 border rounded p-4">
            ...
            <p>
              ...
              <br />
              Get a Refund If Rejected: If rejected, we’ll refund 100% of your
              payment.
              <br />
        ...
        <div className=" col-12">
          <div className="my-2 border rounded p-4">
            ...
            <p>
              ...
              Risk-Free Applications: 100% refund on rejected applications{" "}
              <br />
              Verified Opportunities: Genuine job listings with real employers{" "}
              <br />
              Convenient Tracking: Easily monitor your applications through the
              dashboard <br />
            </p>
          </div>
        </div>
        <div className=" col-12">
          <div className="my-2 border rounded p-4">
            ...
            <p>
              ...
              please contact our support team. We’re here to assist you at every
              step of the way.
            </p>
          </div>
        </div>
        <div className=" col-12">
          <div className="my-2 border rounded p-4">
            ...
            <p>
              ...
              risk in applying. Take the first step toward building your career
              today!
            </p>
          </div>
        </div>

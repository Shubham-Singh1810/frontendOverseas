      ...
      <div className="col-4">
        ...
        <div className="col-6 border rounded p-4 ">
          ...
          <p className="text-center mt-3">
            <small>
              By proceeding, you agree to our <a href="/payment.pdf" target="blank" className="me-1">Terms & Conditions. </a>and
              <a href="/refund.pdf" target="blank" className="ms-1"> Refund Police</a>
            </small>
          </p>
        </div>
      </div>

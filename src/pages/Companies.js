...
function Companies() {
  ...
  const handleScrollToRegister = () => {
    if (employerRegisterRef.current) {
      const offsetTop = employerRegisterRef.current.getBoundingClientRect().top + window.pageYOffset - 200; // Adjust the offset as needed
    ...
    <div className="mt-5 pt-5">
      <div className="mt-5 pt-md-5 container ">
        <div className="d-md-flex justify-content-between my-3 mx-4 pb-3">
          ...
          <button className="btn btn-outline-primary" onClick={handleScrollToRegister}>
            Register As HRA
          </button>
        </div>
        {/* Search and Sort */}
                    ...
                    <img
                      src={
                        v?.cmpLogoS3 === "placeholder/logo.png"
                          ? "https://overseasdata.s3.ap-south-1.amazonaws.com/Company/6/logo.jpg"
                          : v?.cmpLogoS3
                      }
                      className="img-fluid"
                      alt="Company Logo"
        ...
        >
          <div className="col-md-6 col-12 my-auto">
            <div className="py-5">
              ...
              <h1 className="heading">Find the right candidate. Fast.</h1>
